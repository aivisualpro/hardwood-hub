...
setHeader({ title: 'Stain Sign Off', icon: 'i-lucide-stamp', description: 'Internal stain color selection and sign-off' })

const { canCreate, canUpdate, canDelete } = usePermissions('/stain-sign-off')
...
await useAsyncData('stain-sign-off', async () => { await fetchRecords(); return true })
