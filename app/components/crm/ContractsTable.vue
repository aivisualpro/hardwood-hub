                ...
                <HoverCard :open-delay="100" :close-delay="100">
                  ...
                  <HoverCardContent class="w-64 p-4 z-[100] bg-background border border-primary/50 shadow-xl shadow-primary/5 rounded-xl" side="bottom" align="start">
                    ...
                    <div class="space-y-4 relative">
                      ...
                      <div
                        class="absolute left-[11px] top-2 w-[2px] bg-primary rounded-full transition-all duration-500"
                        :class="ct.customerSignatureDate ? 'bottom-3' : ct.sentAt ? 'bottom-[50%]' : 'h-0'"
                      />
                      ...
                      <div class="flex items-start gap-4 relative z-10 w-full" :class="{ 'opacity-100': ct.createdAt, 'opacity-40': !ct.createdAt }">
                        ...
                        <div class="flex-1 min-w-0 pt-0.5">
                          <p class="text-xs font-bold leading-none" :class="{ 'text-muted-foreground': !ct.createdAt }">
                            Draft Created
                          </p>
                      ...
                      <div class="flex items-start gap-4 relative z-10 w-full" :class="{ 'opacity-100': ct.sentAt, 'opacity-40': !ct.sentAt }">
                        ...
                        <div class="flex-1 min-w-0 pt-0.5">
                          <p class="text-xs font-bold leading-none" :class="{ 'text-muted-foreground': !ct.sentAt }">
                            Sent for Signature
                          </p>
                          <p class="text-[10px] text-muted-foreground mt-1.5">
                            {{ ct.sentAt ? formatDate(ct.sentAt) : 'Pending' }}
                          </p>
                        </div>
                      </div>
                      ...
                      <div class="flex items-start gap-4 relative z-10 w-full" :class="{ 'opacity-100': ct.customerSignatureDate, 'opacity-40': !ct.customerSignatureDate }">
                        ...
                        <div class="flex-1 min-w-0 pt-0.5">
                          <p class="text-xs font-bold leading-none" :class="{ 'text-muted-foreground': !ct.customerSignatureDate }">
                            Client Signed
                          </p>
                          <p class="text-[10px] text-muted-foreground mt-1.5">
                            {{ ct.customerSignatureDate ? formatDate(ct.customerSignatureDate) : 'Awaiting Signature' }}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <HoverCard :open-delay="100" :close-delay="100">
                  ...
                  <HoverCardContent class="w-64 p-4 z-[100] bg-background border border-primary/50 shadow-xl rounded-xl" side="bottom" align="start">
                    ...
                    <div class="space-y-4 relative">
                      ...
                      <div class="flex items-start gap-4 relative z-10 w-full">
                        <div
                          class="size-6 rounded-full flex items-center justify-center shrink-0 border-[3px] border-background shadow-sm"
